...
```{r histogram,fig.align="left", fig.height=6, fig.width=6}
...
```{r plot, fig.align="left", fig.height=6,fig.width=6}
...
We will plot a histogram to see the distribution. 
```{r histogram_2,fig.align="left", fig.height=6, fig.width=6}
